...
//http://localhost/slim4-sample/api/v1/contacts
...
//http://localhost/slim4-sample/api/v1/contacts/{id}
$app->get('/v1/contacts/{id}', function (Request $request, Response $response, array $args) {
...
//http://localhost/slim4-sample/api/v1/contacts/{id}
$app->put('/v1/contacts/{id}', function (Request $request, Response $response, array $args) {
...
//http://localhost/slim4-sample/api/v2/contacts/{id}
$app->get('/v2/contacts/{id}', function (Request $request, Response $response, array $args) {
